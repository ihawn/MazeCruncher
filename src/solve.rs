...
pub fn solve_maze(mtx: Vec<Vec<u8>>, size: usize, algo: usize, show_animation: bool, anim_scale: usize, anim_speed_mult: usize, save_maze: bool) 
{
    ...
    match algo
    {
        ...
        3 => crate::algo_astar::astar(mtx, size, start_x, start_y, end_x, end_y, save_maze, show_animation, anim_scale, anim_speed_mult),
        4 => crate::algo_tremaux::tremaux(mtx, size, start_x, start_y, end_x, end_y, save_maze, show_animation, anim_scale, anim_speed_mult),
        ...
        6 => {
            ...
            crate::algo_tremaux::tremaux(mtx.clone(), size, start_x, start_y, end_x, end_y, save_maze, show_animation, anim_scale, anim_speed_mult);
            crate::algo_dijkstra::dijkstra(mtx, size, start_x, start_y, end_x, end_y, save_maze, show_animation, anim_scale, anim_speed_mult);
        }
